...
The Promoted server-side SDK is called in your API server after ranked your own list of content. [Click here for reasons about why we have a server-side SDK?](/promoted-server-side-sdks) 
...
<Card title="Typescript" icon="code" icontype="duotone" href="https://github.com/promotedai/promoted-ts-client">
</Card>
<Card title="Ruby" icon="gem" icontype="duotone" href="https://github.com/promotedai/promoted-ruby-client/">
</Card>
<Card title="Java" icon="js" icontype="duotone" href="https://github.com/promotedai/promoted-java-delivery-client">
</Card>
...
See [How to send features to Promoted?](/how-to-send-features-to-promoted) for explanations on how to send data to Promoted.
