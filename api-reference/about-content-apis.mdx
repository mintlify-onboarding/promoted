...
1. [Upload a batch of content items, mapped from content id to properties](/reference/upload%5Fcontents)
2. [Upload a batch of users, mapped from user id to properties](/reference/upload%5Fusers)
