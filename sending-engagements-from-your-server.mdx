...
Your servers can log records using Promoted's Metrics API. The [Metrics API accepts LogRequest proto messages as JSON HTTP requests](https://github.com/promotedai/schema/search?q=%22message+LogRequest%22).
